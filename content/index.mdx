...
This tutorial aims to get the user comfortable to working with the Avaloq DDK by working through an example domain model like SmallJava and using the different DSLs available in the DDK.  We will begin by installing the Avaloq DDK and introducing the grammar models for the DSLs which will be made. 
...
For now, there is not a way to install the DDK as software directly into Eclipse. Please proceed to
[this](https://github.com/CjSong97/ddk-source) Github link for cloning the repository into your Eclipse instance. Instructions to install will follow below
